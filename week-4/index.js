$(document).ready(function () {
    ...
    $("#addGroup").on("click", function () {
      ...
      let isDuplicate = groups.some(group => group.name.toLowerCase() === grp_name.toLowerCase());
      if (isDuplicate) {
          return alert("This group already exists. Please choose a different name.");
      }
      ...
      if (index !== undefined) {
          ...
          alert(`it will remove all the expenses associated with the ${groupToDelete.name}`)
      ...
      // function to delete th eexpense:
